...
weighted_posterior_belief(f::BasicParticleFilter) = WeightedParticleBelief(f._particle_memory, f._weight_memory)
predicted_belief(f::BasicParticleFilter) = ParticleCollection(f._particle_memory)
